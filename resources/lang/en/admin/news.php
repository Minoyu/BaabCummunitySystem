...
return [
    ...
    'newsCategoryP'=>'Please select a category',
    'newsContent'=>'News Content',
    'coverImg'=>'Cover Image',
    'coverImgTip'=>"Click on the image below to upload <br> If you leave it blank, the News don't have a cover",
    'invalidTime'=>'Expiry date',
    'invalidTimeTip'=>'Articles that exceed the expiry date will not appear in the list, and no invalidation date will be set when left blank',
    'newsPriorityTip1'=>'Priority range 0-20, incremented from left to right, default is 0',
    'newsPriorityTip2'=>'Articles will be sorted first by priority and by release time at the same priority',

    'createNewsCarousel'=>'Create News Center Carousel',
    'newsCarouselList'=>'News Center Carousels List',
