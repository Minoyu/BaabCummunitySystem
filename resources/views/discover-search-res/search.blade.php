...
<span class="search-input mdui-center">
    <form id="discoverSearchForm" action="{{route('showSearchRes')}}" method="get">
        <input id="search" autocomplete="off" name="keywords" value="{{$keywords}}" placeholder="搜索话题、新闻及用户" class="search-input-field search-input-field" style="position: relative" type="text" />
