...
@section('content')
    ...
    <i class="mdui-icon mdui-fab-opened material-icons">add</i>
        ...
        <div class="mdui-fab-dial">
            ...
            <a href="{{route('communityTopicCreate',['zone_id'=>$section->communityZone->id,'section_id'=>$section->id])}}" class="mdui-fab mdui-fab-mini mdui-ripple mdui-color-pink-accent" mdui-tooltip="{content: '{{__('community.createTopics')}}', position: 'left'}"><i class="mdui-icon material-icons">forum</i></a>
        </div>
    </div>
@endsection