<div class="login-dialog mdui-dialog" id="login-dialog">
    ...
    <div class="mdui-dialog-title mdui-color-indigo login-bg">
        ...
        <button onclick="loginToRegister()" class="mdui-btn mdui-ripple dialog-top-tip-button" type="button">{{__('auth.notRegistered')}}</button>
    </div>
    <form id="loginForm">
    ...
    <div id="loginSuccessful" class="mdui-valign success mdui-hidden">
        <div class="mdui-center">
            <i class="mdui-icon material-icons mdui-text-color-green mdui-center icon" id="loginSuccessIcon">check_circle</i>
            <h3 class="mdui-center mdui-m-t-2">{{__('auth.LoginSuccess')}} , <span class="username"></span></h3>
            <div class="btns">
