...
@section('content')
    <div class="mdui-card create-page-card" style="margin-top: 20px">
        <form id="editCommunityTopicForm" method="post" action="{{route('communityTopicUpdate',$topic->id)}}">
            ...
            <button onclick="formPublicSubmit('#editCommunityTopicForm')" class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-pink-accent"><i class="mdui-icon material-icons mdui-icon-left">&#xe145;</i>发布</button>
            <button onclick="formHiddenSubmit('#editCommunityTopicForm')" class="mdui-btn mdui-btn-raised mdui-ripple"><i class="mdui-icon material-icons mdui-icon-left">&#xe541;</i>暂存</button>
