...
@section('content')
        <form id="createNewsCarouselForm" method="post" action="{{route('adminNewsCarouselStore')}}">
            ...
            <button onclick="formPublicSubmit('#createNewsCarouselForm')" class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-pink-accent admin-btn"><i class="mdui-icon material-icons mdui-icon-left">add</i>发布</button>
            <button onclick="formHiddenSubmit('#createNewsCarouselForm')" class="mdui-btn mdui-btn-raised mdui-ripple admin-btn"><i class="mdui-icon material-icons mdui-icon-left">local_cafe</i>暂存</button>
