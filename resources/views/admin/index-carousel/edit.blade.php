...
@section('content')
        <form id="editIndexCarouselForm" method="post" action="{{route('adminIndexCarouselUpdate',$indexCarousel->id)}}">
            ...
            <button onclick="formPublicSubmit('#editIndexCarouselForm')" class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-pink-accent admin-btn"><i class="mdui-icon material-icons mdui-icon-left">add</i>{{__('admin.publish')}}</button>
            <button onclick="formHiddenSubmit('#editIndexCarouselForm')" class="mdui-btn mdui-btn-raised mdui-ripple admin-btn"><i class="mdui-icon material-icons mdui-icon-left">local_cafe</i>{{__('community.save')}}</button>
