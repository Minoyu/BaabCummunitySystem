...
@section('content')
    ...
    <h3 class="admin-title mdui-text-color-indigo">{{__('admin/user-permission.editRole')}}
    ...
    <form action="{{route('adminRoleUpdate',$role->id)}}" method="post">
        ...
        <h3 class="admin-index-title mdui-text-color-indigo">2.{{__('admin/user-permission.roleHasPermissions')}}
