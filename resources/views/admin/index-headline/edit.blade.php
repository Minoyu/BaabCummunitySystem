...
@section('content')
    <form id="editIndexHeadlineForm" method="post" action="{{route('adminIndexHeadlineUpdate',$indexHeadline->id)}}">
        ...
        <button onclick="formPublicSubmit('#editIndexHeadlineForm')" class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-pink-accent admin-btn"><i class="mdui-icon material-icons mdui-icon-left">add</i>发布</button>
        <button onclick="formHiddenSubmit('#editIndexHeadlineForm')" class="mdui-btn mdui-btn-raised mdui-ripple admin-btn"><i class="mdui-icon material-icons mdui-icon-left">local_cafe</i>暂存</button>
