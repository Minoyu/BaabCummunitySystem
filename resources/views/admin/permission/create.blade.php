...
@section('content')
    ...
    <h3 class="admin-title mdui-text-color-indigo">{{__('admin/user-permission.createPermission')}}
    ...
    <form action="{{route('adminPermissionStore')}}" method="post">
        ...
        <div class="mdui-row">
            <div class="mdui-textfield mdui-textfield-floating-label mdui-col-xs-12 mdui-col-sm-10 mdui-col-md-6">
                <h3 class="admin-index-title mdui-text-color-indigo">1.{{__('admin/user-permission.permissionSign')}}</h3>
