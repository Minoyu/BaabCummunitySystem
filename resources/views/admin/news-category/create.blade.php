...
@section('content')
        <form id="createNewsCategoryForm" method="post" action="{{route('adminNewsCategoriesStore')}}">
            ...
            <button onclick="formPublicSubmit('#createNewsCategoryForm')" class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-pink-accent admin-btn"><i class="mdui-icon material-icons mdui-icon-left">add</i>发布</button>
            <button onclick="formHiddenSubmit('#createNewsCategoryForm')" class="mdui-btn mdui-btn-raised mdui-ripple admin-btn"><i class="mdui-icon material-icons mdui-icon-left">local_cafe</i>暂存</button>
